...
Στο πεδίο της τέχνης, ο μύθος παίζει ένα σημαντικό ρόλο κυρίως στους Ρομαντικούς. Για παράδειγμα, το *Ηχώ και Νάρκισσος* του John William Waterhouse [[2]](#link2) εμπνέεται από τον σχετικό μύθο του Οβίδιου. Ο ρομαντισμός ως κίνημα ασκώντας κριτική στην θετικιστική  ορθολογικότητα του διαφωτισμού δεν υποτιμά τη μυθική προσέγγιση του κόσμου, ως προερχόμενη από ένα προ-μοντέρνο, κατώτερο στάδιο ιστορικής ανάπτυξης.


## Εν αρχή ην ο Μύθος; Η Ρομαντική Ευαισθησία

O μύθος του Σαμψών και της Δαλιδά [[3]](#link3) αναπαρίστανται στα δύο παρακάτω έργα του Ρούμπενς και του Ρέμπραντ. 
...
Ο Courbet δημιουργεί τον παραπάνω πίνακα και εντάσσει πάλι τον εαυτό του στην αναπαραστατική αφήγηση. Ο ρεαλισμός του σηματοδοτεί επανάσταση στην τέχνη [[6]](#link6). Αποστρέφεται την ομορφιά και  επιδιώκει να γίνει μαθητής της φύσης ,μιας  παρατήρησης ικανής να μπορέσει να περιγράψει τον κόσμο όπως είναι .
